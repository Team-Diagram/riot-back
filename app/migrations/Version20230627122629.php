 ...
 */
final class Version20230627122629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE measure (id UUID NOT NULL, node_id_id UUID NOT NULL, time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, value JSON NOT NULL, sensor_id INT NOT NULL, PRIMARY KEY(id))');
